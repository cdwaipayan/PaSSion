...
!   ================================================================================================
    ...
    USE COMMONS, ONLY: FLFET, SCHSMIT, LAMTR, FLID, CLUSTERMOVET, CLSTRRATIO, LAMTR, DRCOM, U_EIN_TR
...
!   ##############################################################################################################
    ...
    !   ---------------------------------------------------------------
        ...
        REAL(KIND=DP)       :: DELE_EIN, OLD_EIN_OR, NEW_EIN_OR, RM(3,3)
    ...
    !   TRANSLATIONAL MOVE
        ...
        !   Perform the MC move
            ...
            !   Calculate the change in the harmonic potential energy.
                CALL EINSTEIN_CRYSTAL_TR(PID, DELR, .TRUE., WELL_DIFF)
            ELSE
        ...
        !   Metropolis acceptence criteria
            IF( DRAND48() < EXP(-BETAKB*LAM_SS*WELL_DIFF) ) THEN
